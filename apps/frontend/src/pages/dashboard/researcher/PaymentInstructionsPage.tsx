...
export function PaymentInstructionsPage() {
  ...
  const loadData = async () => {
    try {
      ...
      if (settings.contact_info?.whatsapp_numbers && settings.contact_info.whatsapp_numbers.length > 0) {
  ...
  const [whatsappNumbers, setWhatsappNumbers] = useState<Array<{ number: string; label: string }>>([
      ...
      <div className="space-y-6" dir="rtl">
        <div className="bg-blue-50 border-2 border-blue-300 rounded-xl p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-gray-800">لا توجد رسوم تقديم</h3>
              <p className="text-gray-700 mt-1">يمكنك تقديم بحثك مباشرة دون دفع رسوم.</p>
              <button
        ...
        {paymentStatus !== 'verified' && (
          <div className="mb-6 relative">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors shadow-md"
            >
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
        ...
        <ul className="space-y-2 text-blue-800">
          ...
          <li className="flex items-start gap-2">
            <span className="text-blue-600 mt-1">•</span>
            <span>
              بعد الموافقة، ستتمكن من الوصول إلى صفحة تقديم الأبحاث
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-blue-600 mt-1">•</span>
            <span>
              في حالة وجود أي استفسارات، يمكنك التواصل عبر الواتساب
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-red-600 mt-1 font-bold">⚠️</span>
            <span className="font-bold text-red-700">
              رسوم التقديم صالحة لبحث واحد فقط. بعد تقديم البحث، ستحتاج إلى دفع رسوم جديدة لتقديم بحث آخر.
            </span>
          </li>
        </ul>
      </div>
